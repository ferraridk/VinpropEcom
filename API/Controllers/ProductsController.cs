...
namespace API.Controllers
{
        ...
        public async Task<ActionResult<Product>> CreateProduct([FromForm] CreateProductDto productDto)
    {
        ...
        return BadRequest(new ProblemDetails { Title = "Problemer med at lave nyt produkt" });
        }
    ...
    public async Task<ActionResult<Product>> UpdateProduct([FromForm]UpdateProductDto productDto)
    {
        ...
        return BadRequest(new ProblemDetails { Title = "Problemer med at opdatere produktet" });
    }
        ...
        return BadRequest(new ProblemDetails { Title = "Problemer med at slette produkt" });
        }
    }
}